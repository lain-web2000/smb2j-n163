...
;"INESHDR"
  ...
  .db 2                                         ;  CHR
  .db $33                                       ;  mirroring type and mapper number lower nibble
  .db $10                                       ;  mapper number upper nibble
...
ShufAmtLoop: lda DefaultSprOffsets,x
             ...
             inc IRQUpdateFlag         ;set IRQ update flag
             inc OperMode_Task
             rts
...
ClrN163SND: 
		...
		sta $f000
        lda #%01001110
		sta N163_EXRAM_PROTECT
        jsr LoadMainBank            ;load main PRG bank
SwitchCHRBankAll:
        ldx #$00                    ;set all CHR banks
CHRBankLoop:        
        stx N163_CHR0_SELECT
        inx
        stx N163_CHR1_SELECT
        inx
		stx N163_CHR2_SELECT
        inx
        stx N163_CHR3_SELECT
        inx
		stx N163_CHR4_SELECT
        inx
        stx N163_CHR5_SELECT
        inx
		stx N163_CHR6_SELECT
        inx
		stx N163_CHR7_SELECT
        ldx #$e0
        stx N163_NT0_SELECT
        stx N163_NT2_SELECT
        inx
...
NMIHandler:
	   ...
	   beq SkipIRQ
	   lda #$6c
	   sta N163_IRQTIMER_LOW     ;set N163 IRQ timer to occur at the end of the status bar
	   lda #$e9
	   sta N163_IRQTIMER_HIGH    ;and enable IRQs
...
IRQHandler:
            ...
            sta PPU_CTRL
            lda #$00
            sta N163_IRQTIMER_HIGH   ;disable IRQ timer for the rest of the frame
